...
# -*- coding: utf-8 -*-
#
# samlab documentation build configuration file, created by
...
intersphinx_mapping = {
    ...
    "pymongo": ("http://api.mongodb.org/current", "pymongo.inv"),
...
project = u'Samlab'
copyright = u"2018, National Technology & Engineering Solutions of Sandia, LLC (NTESS).  Under the terms of Contract DE-NA0003525 with NTESS, the U.S. Government retains certain rights in this software"
...
latex_documents = [
    ('index', 'samlab.tex', u'Samlab Documentation',
     u'Sandia National Laboratories', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = "../artwork/samlab.png"
...
man_pages = [
    ('index', 'samlab', u'Samlab Documentation',
...
epub_copyright = u'Copyright 2018, National Technology & Engineering Solutions of Sandia, LLC (NTESS).  Under the terms of Contract DE-NA0003525 with NTESS, the U.S. Government retains certain rights in this software.'


# The basename for the epub file. It defaults to the project name.
#epub_basename = u'samlab'
